...
-- -----------------------------------------------------
-- Data for table `pathology`.`tb_patient`
-- -----------------------------------------------------
START TRANSACTION;
USE `pathology`;
INSERT INTO `pathology`.`tb_patient` (`cd_patient`, `nm_patient`, `ic_active`) VALUES (DEFAULT, 'Fabio William', 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `pathology`.`tb_doctor`
-- -----------------------------------------------------
START TRANSACTION;
USE `pathology`;
INSERT INTO `pathology`.`tb_doctor` (`cd_doctor`, `nm_doctor`, `cd_id_doctor`, `ic_active`) VALUES (DEFAULT, 'William', 'CMR-1002', 1);
...
-- -----------------------------------------------------
-- Data for table `pathology`.`tb_doctor_specialty`
-- -----------------------------------------------------
START TRANSACTION;
USE `pathology`;
INSERT INTO `pathology`.`tb_doctor_specialty` (`cd_doctor_speciality`, `cd_doctor`, `cd_specialty`) VALUES (DEFAULT, 1, 1);
...
-- -----------------------------------------------------
-- Data for table `pathology`.`tb_user`
-- -----------------------------------------------------
START TRANSACTION;
USE `pathology`;
INSERT INTO `pathology`.`tb_user` (`cd_user`, `cd_user_control`, `cd_patient`, `cd_doctor`, `nm_user`, `ds_pass`, `ic_active`) VALUES (DEFAULT, 1, NULL, NULL, 'messhias@gmail.com', '123', 1);
INSERT INTO `pathology`.`tb_user` (`cd_user`, `cd_user_control`, `cd_patient`, `cd_doctor`, `nm_user`, `ds_pass`, `ic_active`) VALUES (DEFAULT, 2, 1, NULL, 'william@gmail.com', '123', 1);
INSERT INTO `pathology`.`tb_user` (`cd_user`, `cd_user_control`, `cd_patient`, `cd_doctor`, `nm_user`, `ds_pass`, `ic_active`) VALUES (DEFAULT, 3,NULL, 1, 'doctor@gmail.com', '123', 1);
