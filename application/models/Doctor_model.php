...
class Doctor_model extends CI_Model {
	...
	**/	
	public function insert($insert = array()){
		return $this->db->insert('tb_doctor', $insert);
	}
	...
	**/	
	public function all(){
		try {
			...
			return array(
				'results'	=> 	$this->db->get('tb_doctor')->result(),
				'num_rows'	=>	$this->db->get('tb_doctor')->num_rows(),
			);
	...
	**/	
	public function select($where = array()){
		try {
			...
			return array(
				'results'	=>	$this->db->get_where('tb_doctor',$where)->result(),
				'num_rows'	=>	$this->db->get_where('tb_doctor',$where)->num_rows(),
			);
